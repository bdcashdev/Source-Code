...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Jundcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Jundcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Jundcoin features */
        {"jundcoin", "masternode", &masternode, true, true, false},
        {"jundcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"jundcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"jundcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"jundcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"jundcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"jundcoin", "startmasternode", &startmasternode, true, true, false},
        {"jundcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"jundcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"jundcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"jundcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"jundcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"jundcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"jundcoin", "mnbudget", &mnbudget, true, true, false},
        {"jundcoin", "preparebudget", &preparebudget, true, true, false},
        {"jundcoin", "submitbudget", &submitbudget, true, true, false},
        {"jundcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"jundcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"jundcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"jundcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"jundcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"jundcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"jundcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"jundcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"jundcoin", "mnsync", &mnsync, true, true, false},
        {"jundcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> jundcoin-cli " + methodname + " " + args + "\n";
}
