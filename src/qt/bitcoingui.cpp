                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Jundcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a JDC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jundcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Jundcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Jundcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Jundcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your JDC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified JDC addresses"));
    ...
    openAction->setStatusTip(tr("Open a jundcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Jundcoin Core help message to get a list with possible Jundcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Jundcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jundcoin network", "", count));
}
...
{
    QString strTitle = tr("Jundcoin Core"); // default title
