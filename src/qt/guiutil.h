...
/** Utility functions used by the Jundcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render JDC addresses in monospace font
...
// Parse "jundcoin:" URI into recipient object, return true on successful parsing
