...
/* Jundcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Jundcoin"
#define QAPP_ORG_DOMAIN "jundcoingame.online"
#define QAPP_APP_NAME_DEFAULT "Jundcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Jundcoin-Qt-testnet"
