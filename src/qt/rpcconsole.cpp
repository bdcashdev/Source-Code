...
// Repair parameters
const QString JUNDCOINWALLET("-jundcoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_jundcoinwallet, SIGNAL(clicked()), this, SLOT(walletJundcoin()));
...
/** Restart wallet with "-jundcoinwallet" */
void RPCConsole::walletJundcoin()
{
    buildParameterlist(JUNDCOINWALLET);
}
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Jundcoin RPC console.") + "<br>" +
