...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Jundcoin Core jundcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  jundcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jundcoin transaction") + "\n" +
                               "  jundcoin-tx [options] -create [commands]   " + _("Create hex-encoded jundcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded jundcoin transaction
