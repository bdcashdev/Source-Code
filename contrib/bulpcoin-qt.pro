...
RESOURCES += src/qt/jundcoin.qrc src/qt/jundcoin_locale.qrc

TRANSLATIONS += src/qt/locale/jundcoin_bg.ts \
                src/qt/locale/jundcoin_de.ts \
                src/qt/locale/jundcoin_en.ts \
                src/qt/locale/jundcoin_es.ts \
                src/qt/locale/jundcoin_fi.ts \
                src/qt/locale/jundcoin_fr.ts \
                src/qt/locale/jundcoin_it.ts \
                src/qt/locale/jundcoin_ja.ts \
                src/qt/locale/jundcoin_pl.ts \
                src/qt/locale/jundcoin_pt.ts \
                src/qt/locale/jundcoin_ru.ts \
                src/qt/locale/jundcoin_sk.ts \
                src/qt/locale/jundcoin_sv.ts \
                src/qt/locale/jundcoin_vi.ts \
                src/qt/locale/jundcoin_zh_CN.ts \
                src/qt/locale/jundcoin_zh_TW.ts
