...
Intro
-----
Jundcoin (JDC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Jundcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run jundcoin-qt.exe.

Jundcoin Core is the original Jundcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Jundcoin transactions;
