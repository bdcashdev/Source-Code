...
Jundcoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<jundcoin_address\> \<monthly_payment_jundcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _5000_ JDC, _12_ times over the course of a year totaling _60000_ JDC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<jundcoin_address\> \<monthly_payment_jundcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `5000` JDC.
