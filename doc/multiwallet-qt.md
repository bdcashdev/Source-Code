...
In order to support loading of multiple wallets in jundcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is jundcoin.cpp.
...
Changes to jundcoin.cpp
----------------------
jundcoin.cpp is the entry point into jundcoin-qt, and as such, will require some minor modifications to provide hooks for
