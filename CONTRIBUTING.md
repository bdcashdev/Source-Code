Contributing to Jundcoin Core
==================================

The Jundcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Jundcoin Core project, and is not to be
confused with overall Jundcoin Network Protocol consensus changes.

Whether a pull request is merged into Jundcoin Core rests with the project merge
...
Patches that change Jundcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Jundcoin consensus, it must have been
...
The project leader is the release manager for each Jundcoin Core release.
