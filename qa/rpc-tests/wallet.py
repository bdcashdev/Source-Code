...
#   c) node1 mines 32 blocks, so now node 0 has 500000JDC, node 1 has 4250JDC, node2 has none.
#   d) node0 sends 601 JDC to node2, in two transactions (301 JDC, then 300 JDC).
